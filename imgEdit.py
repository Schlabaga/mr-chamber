...
def supperpose_image(image_dessus_path, image_dessous_path, rename = ""):
    ...
    # Save the new image
    if rename == "":
        output_path = image_dessus_path
    else: 
        output_path = image_dessus_path.replace("fade.png", f"{rename}.png")
